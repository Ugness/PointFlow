...
def add_args(parser):
    ...
    parser.add_argument('--dataset_type', type=str, default="shapenet15k",
                        help="Dataset types.", choices=['shapenet15k', 'modelnet40_15k', 'modelnet10_15k', 'multimnist'])
    parser.add_argument('--multimnist_sample_size', type=int, default=400,
                        help="MultiMNIST set instance sizes")
